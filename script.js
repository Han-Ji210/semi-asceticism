...
const journeyData = [
    ...
    },
    {
        ...
        lat: 0, 
        lng: 0, 
        description: "이후로 인공지능과 관련된 주제가 여럿 떠올랐지만 곧바로 고민하기를 포기했다. <br>지친 몸은 무언가 깊이 사고하기를 강하게 거부하고 있었다. 왠지 모르게 각각 간격이 100m일 것 같고 0.1씩 줄어드는 숫자가 적힌 표지판을 보고 걷는 것 이외에는 아무것도 할 수 없었다.<br>그렇게 제정신이 아닌 채로 목적지에 닿을 수 있었다. 끝에서 무슨 생각을 했는지는 기억이 잘 나지 않는다. 아마 노트북을 챙겨간 것을 후회하거나 과제에 대한 부질없는 불평을 하고 있었을 것이다.",
